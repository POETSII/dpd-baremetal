...
mol new oil-water-timestep-0.pdb waitfor -1
# Add later files to the first molecule
# mol addfile ... waitfor -1
mol addfile oil-water-timestep-50.pdb waitfor -1

# Change representation
# Set drawing form to VDW at size 0.2
mol modstyle 0 0 VDW 0.1
...
color Element O red
# Set oil2 to green
color Element A green

# Turn shadows and ambient occlusion on
display shadows on
display ambientocclusion on

# Set centre to middle of volume
molinfo top set center {{50 50 50}}

# Move the center into view
translate to 0 0 0
